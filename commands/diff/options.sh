...
# Created: Wed Jul 29 14:13:55 PDT 2015
#
#/ usage: docker-container:diff  --docker-cert-path <${DOCKER_CERT_PATH:-}>  --docker-host <${DOCKER_HOST:-}>  --docker-tls-verify <${DOCKER_TLS_VERIFY:-}>  --container <> 
