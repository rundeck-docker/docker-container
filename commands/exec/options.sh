...
# Created: Wed Jul 29 14:22:22 PDT 2015
#
#/ usage: docker-container:exec  --docker-cert-path <${DOCKER_CERT_PATH:-}>  --docker-host <${DOCKER_HOST:-}>  --docker-tls-verify <${DOCKER_TLS_VERIFY:-}>  --container <>  --detatch <false>  --command <> [ --exec-user <>] 
...
rerun_options_parse() {
    ...
    while [ "$#" -gt 0 ]; do
        ...
        case "$OPT" in
            ...
            --exec-user) rerun_option_check $# $1; EXEC_USER=$2 ; shift ;;
            # help option
            -|--*?)
                rerun_option_usage
                exit 2
    ...
    [ -z "$DETATCH" ] && { echo >&2 "missing required option: --detatch" ; return 2 ; }
