...
# Created: Wed Jul 29 15:48:40 PDT 2015
#
#/ usage: docker-container:kill  --docker-cert-path <${DOCKER_CERT_PATH:-}>  --docker-host <${DOCKER_HOST:-}>  --docker-tls-verify <${DOCKER_TLS_VERIFY:-}>  --container <> [ --signal <>] 
...
rerun_options_parse() {
    ...
    while [ "$#" -gt 0 ]; do
        ...
        case "$OPT" in
            ...
            --signal) rerun_option_check $# $1; SIGNAL=$2 ; shift ;;
            # help option
            -|--*?)
                rerun_option_usage
                exit 2
