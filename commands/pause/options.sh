...
# Created: Tue Jul 28 16:52:23 PDT 2015
#
#/ usage: docker-container:pause  --docker-cert-path <${DOCKER_CERT_PATH:-}>  --docker-host <${DOCKER_HOST:-}>  --docker-tls-verify <${DOCKER_TLS_VERIFY:-}>  --container <> 
