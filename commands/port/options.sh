...
# Created: Wed Jul 29 15:23:31 PDT 2015
#
#/ usage: docker-container:port  --docker-cert-path <${DOCKER_CERT_PATH:-}>  --docker-host <${DOCKER_HOST:-}>  --docker-tls-verify <${DOCKER_TLS_VERIFY:-}>  --container <> [ --private-port <>] 
...
rerun_options_parse() {
    ...
    while [ "$#" -gt 0 ]; do
        ...
        case "$OPT" in
            ...
            --private-port) rerun_option_check $# $1; PRIVATE_PORT=$2 ; shift ;;
            # help option
            -|--*?)
                rerun_option_usage
                exit 2
