...
# Created: Wed Jul 29 15:30:11 PDT 2015
#
#/ usage: docker-container:rename  --docker-cert-path <${DOCKER_CERT_PATH:-}>  --docker-host <${DOCKER_HOST:-}>  --docker-tls-verify <${DOCKER_TLS_VERIFY:-}>  --container <>  --new-name <> 
...
rerun_options_parse() {
    ...
    while [ "$#" -gt 0 ]; do
        ...
        case "$OPT" in
            ...
            --new-name) rerun_option_check $# $1; NEW_NAME=$2 ; shift ;;
            # help option
            -|--*?)
                rerun_option_usage
                exit 2
    ...
    [ -z "$NEW_NAME" ] && { echo >&2 "missing required option: --new-name" ; return 2 ; }
