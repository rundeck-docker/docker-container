...
# Created: Wed Jul 29 15:42:11 PDT 2015
#
#/ usage: docker-container:restart  --docker-cert-path <${DOCKER_CERT_PATH:-}>  --docker-host <${DOCKER_HOST:-}>  --docker-tls-verify <${DOCKER_TLS_VERIFY:-}>  --container <> [ --time <>] 
...
rerun_options_parse() {
    ...
    while [ "$#" -gt 0 ]; do
        ...
        case "$OPT" in
            ...
            --time) rerun_option_check $# $1; TIME=$2 ; shift ;;
            # help option
            -|--*?)
                rerun_option_usage
                exit 2
