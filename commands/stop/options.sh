...
# Created: Wed Jul 29 15:46:40 PDT 2015
#
#/ usage: docker-container:stop  --docker-cert-path <${DOCKER_CERT_PATH:-}>  --docker-host <${DOCKER_HOST:-}>  --docker-tls-verify <${DOCKER_TLS_VERIFY:-}>  --container <> [ --time <>] 
